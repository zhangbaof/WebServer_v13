...
public class PointCutAspect {
	 ...
	 * 如下程序将在userService和dictService全部方法之前执行test()方法
	 */
	...
	/**
	 * 切入点表达式bean(*Service)将会拦截全部的业务层方法，每个业务层方法之前都会
	 * 执行test1()方法，使用这种方式进行切入时候，建议有统一的命名规范
	 */
/*	@Before("bean(*Service)")
	public void test1() {
		System.out.println("Point Cut Test!");
	...
	/**
	 * 类的切入点，如下切入点表达式将test2方法切入到UserServiceImpl的全部方法之前执行
	 */
