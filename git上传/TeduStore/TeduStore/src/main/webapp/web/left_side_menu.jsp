...
<div id="leftsidebar_box" class="lf">
        ...
        <dl class="my_order">
            ...
            <dd class="first_dd"><a href="${pageContext.request.contextPath}/order/orderList.do">全部订单</a></dd>
            <dd>
                <a href="#">
                    待付款
                    <span><!--待付款数量--></span>
        ...
        <dl class="count_managment">
            ...
            <dd class="first_dd"><a href="${pageContext.request.contextPath}/user/user_center.do">我的信息</a></dd>
            <dd><a href="${pageContext.request.contextPath}/user/user_password.do">安全管理</a></dd>
        </dl>
    </div>
    
   <script type="text/javascript">
   //显示某个分组，参数表示需要显示的分组的id或class
