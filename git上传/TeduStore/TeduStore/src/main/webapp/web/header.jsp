...
<header id="top" class="fixed_nav">
    ...
    <div class="rt">
        ...
        <c:if test="${sessionScope.uid!=null}">
          <li>
            <a href="${pageContext.request.contextPath}/user/user_center.do">
            
            ${sessionScope.username}</a><b>|</b>
            
          </li>
        </c:if>
            <li><a href="favorites.html" title="我的收藏"><img class="care" src="../images/header/care.png" alt=""/></a><b>|</b></li>
            <li><a href="${pageContext.request.contextPath}/order/orderList.do" title="我的订单"><img class="order" src="../images/header/order.png" alt=""/></a><b>|</b></li>
