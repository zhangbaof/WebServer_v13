    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <div class="item_cat_all">
                <p>${category161[0].name }</p>
                <ul>
                <c:forEach var="category" items="${subCategories[0]}">
                  <li><a href="${pageContext.request.contextPath}/goods/list.do?id=${category.id}">${category.name}</a></li>
                </c:forEach>
                </ul>
                
                <p>${category161[1].name }</p>
                <ul>
                  <c:forEach var="category" items="${subCategories[1]}">
                    <li><a href="${pageContext.request.contextPath }/goods/list.do?id=${category.id}">${category.name}</a></li>
                  </c:forEach>
                </ul>
                <p>${category161[2].name }</p>
                <ul>
                  <c:forEach var="category" items="${subCategories[2]}">
                    <li><a href="${pageContext.request.contextPath }/goods/list.do?id=${category.id}">${category.name}</a></li>
                  </c:forEach>
                </ul>
            </div>
        ...
        <c:forEach items="${hotNotebooks}" var="notebook">
            <div class="item_msg lf">
                <img width="180" src="${pageContext.request.contextPath}${notebook.image}" alt="${notebook.title}" title="${notebook.title}" />
    
                <p class="bottom_ys2">${notebook.title}</p>
    
                <p class="bottom_ys3">${notebook.price}.00</p>
    
                <p class="bottom_ys4 color_2"><a href="${pageContext.request.contextPath}/goods/details.do?id=${notebook.id}">查看详情</a></p>
            </div>
        </c:forEach>
