    ...
    <div id="preview" class="lf">
        ...
        <div id="icon_all">
            ...
            <c:forEach var="i" begin="1" end="5">
              <li class="i1"><img src="${pageContext.request.contextPath}${image}/${i}.jpg"/></li>
            </c:forEach>
      ...
      <!--   <p class="style" id="choose_color">
        ...
        <p id="_goods_list">
            ...
            <c:forEach items="${goodsList}" var="_goods">
              ...
              " href="${pageContext.request.contextPath}/goods/details.do?id=${_goods.id}">${_goods.title}</a>
        ...
        <form id="buyForm">
              <s>数量：</s>
              <input type="button" class="numberMinus" value="-"></input>
              <input type="text" value="1" name="num" class="number" id="buy-num">
              <input type="button" class="numberAdd" value="+"></input>
        ...
        <div class="shops">
            ...
            <a href="#" class="shop lf" id="addCart"><img src="../images/product_detail/product_detail_img7.png" alt=""/>加入购物车</a>
