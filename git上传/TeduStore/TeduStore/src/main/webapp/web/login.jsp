        ...
        <form id="login-form" method="post" name="form1">
          ...
          登录学子商城<span><a href="register.do">新用户注册</a></span>
                ...
                <div class="text">
                    ...
                    <span><img id="code_image" style="top:-39px;right:-155px" src="code.do"></span>
                </div>
...
<div class="foot_bj">
    ...
    <!-- 页面底部-备案号 #footer -->
            <div class="record">
                &copy;<a href="downloadImage.do">下载</a>
                <a href="downloadExcel.do">下载表格</a>2017 达内集团有限公司 版权所有 京ICP证xxxxxxxxxxx
      </div>
    </div>
</div>
