...
<div id="container" class="clear">
    ...
    <form name="" method="post" action="#">
        <div class="product_confirm">
            ...
            <c:forEach items="${cartsItems}" var="item">
            <ul class="item_detail">
                <li class="p_info">
                    <b><img  class="cart_goods_image" src="${pageContext.request.contextPath}${item.goodsImage}"/></b>
                ...
                <li class="p_count">X<span>${item.num}</span></li>
...
<script>
    $(".go_pay").click(function () {
        location.href = "${pageContext.request.contextPath}/order/orderReplay.do?id="+${recvList.id};
    })
</script>
<script>
